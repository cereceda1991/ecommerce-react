...
//           <li
//             className={`slider-img-container-child ${index === indexImg && 'slider-border'
//               }`}
...
const SliderImg = ({ listImgs }) => {
  ...
  return (
    <div className="slider">
      ...
      <div style={styleContainer} className="slider-container">
        {listImgs?.map((url) => (
          <div className="slider-img-container" key={url.url}>
            <img className="slider-img" src={url.url} alt="product-img" />
          </div>
        ))}
      </div>
      <button onClick={handleNext} className="slider-next">
